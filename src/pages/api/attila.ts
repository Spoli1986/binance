...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
	...
	const handleCase: ResponseFuncs = {
		GET: async (req: NextApiRequest, res: NextApiResponse) => {
			...
			if (session) {
				const API_KEY =
					process.env.NEXT_PUBLIC_BINANCE_KEY_64e5f408f536ed080e34d9b1;
				const API_SECRET =
					process.env.NEXT_PUBLIC_BINANCE_SECRET_64e5f408f536ed080e34d9b1;
				...
				console.log("Setting up socket Attila");
			} else {
				// Not Signed in
