...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
	...
	const handleCase: ResponseFuncs = {
		GET: async (req: NextApiRequest, res: NextApiResponse) => {
			...
			if (session) {
				const API_KEY = process.env.NEXT_PUBLIC_BINANCE_KEY_PETI;
				const API_SECRET = process.env.NEXT_PUBLIC_BINANCE_SECRET_PETI;
				...
				console.log("Setting up socket KPeti");
			} else {
				// Not Signed in
